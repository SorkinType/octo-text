...
def analyze_text(input_file, output_file):
    ...
    def get_ngrams(n):
        ...
        return ["".join(ngram) for ngram, _ in sorted_ngrams[:25]]
    ...
    with open(output_file, 'w', encoding='utf-8') as file:
        ...
        file.write("Lowercase - most frequent to least:\n")
        file.write(' '.join(lowercase_letters) + '\n\n')

        # Write the uppercase letters in order
        file.write("Uppercase - most frequent to least:\n")
        ...
        file.write("25 most common bigrams:\n")
        bigrams = get_ngrams(2)
        file.write(' '.join(bigrams) + '\n\n')

        file.write("25 most common trigrams:\n")
